...
function UploadPage() {
    ...
    const addIngeridant = () => {
        ...
        const newIngeridants = [...ingeridants, {
            id: uuid(),
            name: name,
            quantity: quantity,
            unit: unit
        ...
        <div className={styles.container}>
                ...
                <label htmlFor="image" className={styles.preview}>
                    {selectedImage === null && <div className={styles.placeholder}>Upload an image for your recipe</div>}
                    {
                        ...
                        <div className={styles.image}>
                            ...
                            <div className={styles.overlay}>Click to change the image</div>
                        </div>
                    }
                </label>
            ...
            <div className={styles.recipe_ingeridants}>
                ...
                <ul>
                    {
                        ingeridants.map(item =>
                            <li key={item.id}>
                                ...
                                <p className={styles.quantity}>{item.quantity} {item.unit}</p>
                                <button onClick={removeIngeridant.bind(this, item.id)} className={styles.remove}>Remove</button>
                            </li>
                        )
                    }
                </ul>
                <div className={styles.input}>
                    ...
                    <SelectInput placeholder="Unit" options={[]} />
            ...
            <div className={styles.recipe_instruction}>
                ...
                <div className={styles.instruction_preview}>
                    {parser(instruction)}
                </div>
            </div>
            <footer className={styles.recipe_actions}>
                <AccentButton title="Discard" type="danger" />
                <OutlineButton title="Save Draft" type="primary" />
